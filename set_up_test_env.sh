...
mkdir -p "$PWD/Data/ORION_storage"
export ORION_STORAGE="$PWD/Data/ORION_storage/"

#ORION_GRAPHS - a directory for storing knowledge graphs
mkdir -p "$PWD/Data/ORION_graphs"
export ORION_GRAPHS="$PWD/Data/ORION_graphs/"

#ORION_LOGS - a directory for storing logs
mkdir -p "$PWD/Data/ORION_logs"
export ORION_LOGS="$PWD/Data/ORION_logs/"
...
export ORION_GRAPH_SPEC=default-graph-spec.yml
# export ORION_GRAPH_SPEC=mw-monarch.yaml
